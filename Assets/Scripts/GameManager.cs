...
public class GameManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        btRanking.onClick.AddListener(OnClickButtonRanking);
    ...
    private void OnDisable()
    {
        ...
        btRanking.onClick.RemoveAllListeners();
    ...
    {
        string tmpText = value ? "View 2.5d" :  "View 2d";
    ...
    private void OnClickButtonRanking()
    {
